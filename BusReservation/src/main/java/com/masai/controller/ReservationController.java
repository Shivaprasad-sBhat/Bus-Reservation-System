...
public class ReservationController {
	...
	public ResponseEntity<Reservation> addReservation(@Valid @RequestBody Reservation reservation) throws ReservationException {
		
		Reservation bookedReservation = rService.addReservation(reservation);
